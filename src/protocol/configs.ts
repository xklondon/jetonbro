...
export const BLACKJACK_PROTOCOL: ProtocolConfig = {
  ...
  actions: [
    { id: 'assign-chips', phase: 'setup', role: 'bank', creditsGame: true },
    { id: 'top-up', phase: 'setup', role: 'bank', creditsGame: true },
    ...
    { id: 'declare-outcome', phase: 'resolution', role: 'bank', requiresBox: true, resolvesBox: true, resolvesPot: true },
